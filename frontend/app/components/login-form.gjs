...
const T = {
  en: {
    ...
    mobileHint:        "We'll send a one-time code to this number via SMS",
    sending:           'Sending…',
    sendOtp:           'Send OTP via SMS',
    otpSentPrefix:     'OTP sent to',
    otpSentSuffix:     'via SMS',
    otpLabel:          'Enter OTP',
  ...
  ta: {
    ...
    mobileHint:        'இந்த எண்ணுக்கு SMS மூலம் ஒரு முறை குறியீடு அனுப்புவோம்',
    sending:           'அனுப்புகிறது…',
    sendOtp:           'SMS மூலம் OTP அனுப்பு',
    otpSentPrefix:     '',
    otpSentSuffix:     '-க்கு SMS மூலம் OTP அனுப்பப்பட்டது',
