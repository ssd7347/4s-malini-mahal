...
const T = {
  ...
  ta: {
    ...
    heroTitle:     '4S மாலினி மஹால்',
    heroSub:       'திருத்தங்கலில் சிறந்த கல்யாண மண்டபம்',
    bookNow:       'இப்போது பதிவிடுங்கள்',
    checkAvail:    'தேதி கிடைப்பை சரிபார்க்கவும்',

    welcomeTitle:  '4S மாலினி மஹால்க்கு வரவேற்கிறோம்',
    welcomeBody:   'திருத்தங்கல் மையத்தில் அமைந்த 4S மாலினி மஹால், திருமணங்கள், வரவேற்புகள் மற்றும் குடும்ப விழாக்களுக்காக முழுவதும் ஏர்கண்டிஷன் வசதியுடன் அமைக்கப்பட்ட விழா மண்டபம். இரண்டு தளங்களில் 200 விருந்தினர்கள் வரை அமரலாம்.',
