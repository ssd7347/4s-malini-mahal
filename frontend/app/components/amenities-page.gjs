...
export default class AmenitiesPage extends Component {
  ...
  <template>
    <div class="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-4">
      ...
      <div class="group flex flex-col items-center text-center gap-5 rounded-2xl bg-rose-50 border border-rose-100 p-6 shadow-sm hover:-translate-y-1 hover:shadow-md transition-all duration-300">
        <h3 class="font-bold text-rose-800 text-xs sm:text-sm uppercase tracking-wide leading-snug">
          {{this.t.hallTitle}}
        </h3>
        <div class="h-20 w-20 sm:h-24 sm:w-24 rounded-full bg-rose-700 flex items-center justify-center shadow group-hover:scale-105 transition-transform duration-300">
